...
const ALL = [...BRAIN_BROWSER, ...BRAIN_MEDIA, ...BRAIN_KNOWLEDGE, ...BRAIN_DEV, ...BRAIN_WORLD, ...BRAIN_MONEY, ...BRAIN_WEB, ...BRAIN_DOCS, ...RESEARCH, ...MARKETS, ...WORLD, ...LIFE, ...DEV, ...MEDIA, ...AI, ...SELF, ...COMMS, ...JOBS].filter(t => !DROPPED.has(t.name));
