...
export const REQUIRED_SECRETS = [
  ...
  'TWELVE_DATA_API_KEY', 'AGENT_KEY_JARVIS_RAYVEN', 'AGENT_KEY_RAYVEN_ACHILLES'
];
export const OPTIONAL_SECRETS = ['OPENROUTER_API_KEY', 'JARVIS_AGENT_URL', 'ACHILLES_AGENT_URL', 'ELEVENLABS_VOICE_ID', 'ELEVENLABS_VOICE_ID_HELA', 'TELEGRAM_BOT_TOKEN_HELA', 'TELEGRAM_BOT_TOKEN_THOR', 'AYRSHARE_API_KEY', 'UPLOAD_POST_API_KEY', 'VIZARD_API_KEY', 'TWITCH_CLIENT_ID', 'TWITCH_CLIENT_SECRET', 'CF_ANALYTICS_TOKEN', 'CF_ACCOUNT_ID'];
