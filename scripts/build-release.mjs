...
const release={name:'Bifrost Aperture',id:`bifrost-${fingerprint.slice(0,12)}`,sourceBase:execFileSync('git',['rev-parse','HEAD'],{encoding:'utf8'}).trim(),fingerprint,assets};
