...
### Owner phone conversation update — 2026-09-14
Source 9510bd0 deployed as 55a437d7-8a04-432c-9173-0c462f4d598a. Owner phone prompt explicitly supports questions, topic changes and follow-ups to update calls. Adds ASGARD Browser Control identity, distinction from Agent Face, and latest recorded heartbeat with uncertainty/cause guidance. Outbound owner calls now allow 20 turns and up to 600 seconds, bounded by existing quiet hours. Existing scoped tools, signature checks and permissions retained. 229 Node tests pass; built Worker/SQLite checks pass. Live safety smoke checks passed including three persona web replies. No live telephone conversation was placed or heard, so the reported refusal and conversational audio quality remain awaiting a real call check. This is not evidence of instant response latency. Rollback predecessor: 86757111-911c-4f49-8a0e-7ebfb9d3969f. Website assets unchanged; pre-existing companion and face edits preserved.
